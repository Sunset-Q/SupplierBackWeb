...
<!--      <router-link to="/store/petStore">宠物库存</router-link>-->
<!--      <router-link to="/store/proStore">宠物用品库存</router-link>-->
      <!--        <JsonTable-->
...
<!--            <el-button type="primary" size="mini" @click="handleCheck(scope)">修改库存</el-button>-->
<!--        </template>-->
<!--        </JsonTable>-->
    </div>
</template>
...
// import {searchColumns, tableColumns, localService, options} from "@/components/JsonTable/storeConfig";
export default {
//     setup(props, {emit}) {
