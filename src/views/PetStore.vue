...
import {searchColumns, tableColumns, localService, options} from "@/components/JsonTable/storePetConfig";
...
export default {
    setup(props, {emit}) {
        ...
        //         type: 'warning'
        //         }).then(() => {
        //           // request.post('http://localhost:9090/petshop/supplier/confirmOrder/pet',val.tableColumns.petID);
